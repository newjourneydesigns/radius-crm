...
COMMENT ON COLUMN circle_leaders.additional_leader_name IS 'Name of co-leader or spouse';
COMMENT ON COLUMN circle_leaders.additional_leader_phone IS 'Phone number of additional leader';
COMMENT ON COLUMN circle_leaders.additional_leader_email IS 'Email address of additional leader';
