...
export default function CircleLeaderVisitsPage() {
    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl shadow-card-glass p-6">
            <CircleVisitsSection leaderId={leaderId} leaderName={leaderName} />
          </div>
