                              ...
                              <>
                                ...
                                <div className="sm:hidden">
                                  ...
                                  <div className="flex flex-wrap items-center gap-2 mb-3">
                                    <button onClick={() => handleEditNote(note)} disabled={editingNoteId !== null || isDeletingNote} className="px-3 py-1.5 text-xs font-medium rounded-md border border-zinc-600 text-slate-300 hover:border-blue-500/60 hover:text-blue-400 hover:bg-blue-500/10 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
                                      Edit
                                    </button>
                                    <button onClick={() => handleSaveAsTemplate(note)} disabled={editingNoteId !== null || isDeletingNote || isSavingAsTemplate === note.id} className="px-3 py-1.5 text-xs font-medium rounded-md border border-zinc-600 text-slate-300 hover:border-emerald-500/60 hover:text-emerald-400 hover:bg-emerald-500/10 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
                                    ...
                                    {deletingNoteId === note.id ? (
                                      <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => handleDeleteNote(note.id)} disabled={isDeletingNote} className="px-3 py-1.5 text-xs font-medium rounded-md border border-red-500/50 text-red-400 hover:bg-red-500/10 disabled:opacity-40 transition-colors">
                                          {isDeletingNote ? 'Deleting…' : 'Yes, delete'}
                                        </button>
                                        <button onClick={() => setDeletingNoteId(null)} disabled={isDeletingNote} className="px-3 py-1.5 text-xs font-medium rounded-md border border-zinc-600 text-slate-300 hover:bg-zinc-700 disabled:opacity-40 transition-colors">
                                          Cancel
                                        </button>
                                      </div>
                                    ) : (
                                      <button onClick={() => handleDeleteNote(note.id)} disabled={editingNoteId !== null || isDeletingNote} className="px-3 py-1.5 text-xs font-medium rounded-md border border-zinc-600 text-slate-300 hover:border-red-500/60 hover:text-red-400 hover:bg-red-500/10 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
                                        Delete
                                      </button>
                                    )}
                                  </div>
