...
// This kills the previous client-side /api/circle-leader-toolkit/me round trip and
...
export default async function CircleSummarySignInPage() {
  ...
  if (leader?.ccb_group_id != null) {
    ...
    redirect(`/circle-leader-toolkit/${leader.ccb_group_id}/events/`);
  }
  ...
  return (
    <>
      <header className="cs-hero py-14 sm:py-20 px-6 text-center">
        ...
        />
        <h1 className="cs-display text-5xl sm:text-7xl">Circles Toolkit</h1>
