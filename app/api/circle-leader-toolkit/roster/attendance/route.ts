/**
 * GET /api/circle-leader-toolkit/roster/attendance
 ...
 * lib/circle-leader-toolkit/roster-data.ts.
 */

import { NextResponse } from 'next/server';
import { getSessionLeader, unauthorized } from '../../../../../lib/circle-leader-toolkit/session';
import { loadLeaderAttendance } from '../../../../../lib/circle-leader-toolkit/roster-data';
