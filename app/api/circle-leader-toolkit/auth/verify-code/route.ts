...
import { attachSessionCookie, isCircleSummaryAccessEnabled } from '../../../../../lib/circle-leader-toolkit/session';
...
export async function POST(req: Request) {
  ...
  // group-scoped events URL, skipping the legacy /circle-leader-toolkit/events
