...
import { buildCircleSummaryUrl, deliverLeaderPush, parseCcbDateTime } from '../../../../lib/circle-summary/push';
  ...
  for (const leader of leaders || []) {
    ...
    try {
      ...
      for (const event of events || []) {
        ...
        const route = `/circle-summary/${encodeURIComponent(String(leader.ccb_group_id))}/events/${encodeURIComponent(String(event.eventId))}/${encodeURIComponent(String(event.startDateTime))}`;
