 ...
 *
 * GET /api/circle-summary/sessions?leader_id=123
 * PATCH /api/circle-summary/sessions { leader_id, enabled }
 */

import { NextRequest, NextResponse } from 'next/server';
import { verifyAdminAccess } from '../../../../lib/auth-middleware';
import { createServiceSupabaseClient } from '../../../../lib/server-supabase';
import { isLeaderEligible, revokeLeaderSessions } from '../../../../lib/circle-summary/session';
