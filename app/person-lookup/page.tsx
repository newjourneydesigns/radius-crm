                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '6px' }}>
                    {contactPhone && (
                      <button
                        type="button"
                        onClick={() => handleCopyField(contactPhone, 'phone')}
                        ...
                        style={{
                          ...
                          gap: '4px',
                          fontSize: '13px',
                          color: copiedField === 'phone' ? '#34d399' : '#9ca3af',
                          background: 'none',
                          border: 'none',
                          padding: '0',
                          cursor: 'pointer',
                      ...
                      >
                        ...
                        {copiedField === 'phone' ? 'Copied!' : contactPhone}
                      </button>
                    )}
                    {selectedPerson.email && (
                      <button
                        type="button"
                        onClick={() => handleCopyField(selectedPerson.email, 'email')}
                        ...
                        style={{
                          ...
                          gap: '4px',
                          fontSize: '13px',
                          color: copiedField === 'email' ? '#34d399' : '#9ca3af',
                          background: 'none',
                          border: 'none',
                          padding: '0',
                          cursor: 'pointer',
                      ...
                      >
                        ...
                        {copiedField === 'email' ? 'Copied!' : selectedPerson.email}
                      </button>
                    )}
                  </div>
                </div>
