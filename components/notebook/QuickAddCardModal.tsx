      ...
      <div className="fixed inset-x-4 top-1/4 z-50 max-w-sm mx-auto bg-[#1e2130] border border-white/[0.1] rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="px-4 py-4 space-y-3">
          ...
          <div>
            <input
              ...
              className="w-full bg-white/[0.06] border border-white/[0.1] rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-vc-400/60 transition-colors"
            />
          </div>
        ...
        <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-white/[0.06]">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 bg-vc-600 hover:bg-vc-500 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving ? (
