                    ...
                    <td className="px-3 py-4 sm:px-6 whitespace-nowrap hidden lg:table-cell">
                      {leader.ccb_profile_link ? (
                        <a
                          ...
                          className="inline-flex items-center px-3 py-2 bg-gray-100/80 dark:bg-gray-700/60 text-gray-700 dark:text-gray-300 hover:bg-gray-200/80 dark:hover:bg-gray-600/60 rounded-xl transition-all duration-200 text-xs font-medium hover:scale-[1.02] active:scale-[0.98] backdrop-blur-sm"
