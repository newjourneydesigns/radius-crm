        ...
        <div className="flex flex-col space-y-2">
          {phone && (
            <>
              <button
                onClick={handleCall}
                className="btn-success group flex items-center justify-center px-4 py-3 rounded-xl text-sm"
              >
              ...
              <button
                onClick={handleText}
                className="btn-primary group flex items-center justify-center px-4 py-3 rounded-xl text-sm"
              >
                <svg className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
