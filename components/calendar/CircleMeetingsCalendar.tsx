        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between gap-3 px-3 py-2 rounded-xl border border-purple-500/25 bg-purple-500/8">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-xs font-semibold text-purple-300 whitespace-nowrap">AI Weekly Summary</span>
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              {generatedSummary && !isSavingSummary && (
                <>
                  <button
                    ...
                    className="btn-primary inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-semibold"
                  >
                    <svg className="w-3 h-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              ...
              {!generatedSummary && !savedSummary && (
                <button
                  ...
                  className="btn-primary inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold"
                >
                  {isGeneratingSummary ? (
                    <>
