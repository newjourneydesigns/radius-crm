-- ============================================================
-- Project Management / Kanban Board Tables
-- ============================================================
...
-- Policies: authenticated users can see all boards (team-shared)
CREATE POLICY "Authenticated users can view boards"
  ON project_boards FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert boards"
  ON project_boards FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Authenticated users can update boards"
  ON project_boards FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Authenticated users can delete boards"
  ON project_boards FOR DELETE TO authenticated USING (auth.uid() = user_id);

CREATE POLICY "Authenticated users can view columns"
  ON board_columns FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage columns"
  ON board_columns FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view labels"
  ON board_labels FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage labels"
  ON board_labels FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view cards"
  ON board_cards FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage cards"
  ON board_cards FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view card_label_assignments"
  ON card_label_assignments FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage card_label_assignments"
  ON card_label_assignments FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view comments"
  ON card_comments FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage comments"
  ON card_comments FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view checklists"
  ON card_checklists FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage checklists"
  ON card_checklists FOR ALL TO authenticated USING (true);
